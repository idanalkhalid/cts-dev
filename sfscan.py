...
from cts import SpiderFootDb, SpiderFootEvent, SpiderFootPlugin, SpiderFootTarget, SpiderFootHelpers, SpiderFootThreadPool, SpiderFootCorrelator, logger
...
class SpiderFootScanner():
    ...
    def __init__(self, scanName: str, scanId: str, targetValue: str, targetType: str, moduleList: list, globalOpts: dict, created_by: str, start: bool = True) -> None:
        ...
        self.__dbh.scanInstanceCreate(
            self.__scanId, self.__scanName, self.__targetValue, self.__createdBy)
